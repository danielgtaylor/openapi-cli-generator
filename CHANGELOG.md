...
## 2019-03-09
- Generate methods of the format `{{ API Name }}{{ Operation Name }}(args []string, params *viper.Viper)` for each API operation. These can be used by custom code as if you were invoking the CLI, but it returns rather than formats the response.
